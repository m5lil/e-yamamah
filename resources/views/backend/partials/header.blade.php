...
<div class="br-header">
    <div class="br-header-left">
        ...
        <div class="input-group hidden-xs-down wd-170 transition">
                <input id="searchbox" type="text" name="query"  class="typeahead form-control" placeholder="Search">
        ...
        <nav class="nav">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-header wd-250">
                    <div class="tx-center">
                        <a href=""><img src="{{ url('backend/img/img1.jpg') }}" class="wd-80 rounded-circle" alt=""></a>
                    ...
                    <ul class="list-unstyled user-profile-nav">
                        ...
                        <li><a href="{{route('backend.logout')}}"><i class="icon ion-power"></i> Sign Out</a></li>
                    </ul>
                </div><!-- dropdown-menu -->
            </div><!-- dropdown -->
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-header wd-250">
                    <ul class="list-unstyled user-profile-nav">
                        <li><a href="{{ route('backend.lang', 'ar') }}"><i class="fa fa-globe"></i> @lang('Arabic')</a></li>
                        <li><a href="{{ route('backend.lang', 'en') }}"><i class="fa fa-globe"></i> @lang('English')</a></li>
                    </ul>
                </div><!-- dropdown-menu -->
            </div><!-- dropdown -->
        </nav>
