...
<div class="br-sideleft sideleft-scrollbar">
    <label class="sidebar-label pd-x-10 mg-t-20 op-3">{{ date("Y-m-d H:i:s") }}</label>
    <ul class="br-sideleft-menu">
        <li class="br-menu-item">
            <a data-pjax href="{{ url('/system') }}" class="br-menu-link data-pjax">
                <i class="menu-item-icon icon ion-ios-home-outline tx-24"></i>
                <span class="menu-item-label">@lang('Home')</span>
            </a>
        </li>
        @include('backend.partials.sidebar_links')
    </ul>
    {{--<ul class="br-sideleft-menu">--}}
        {{--<li class="br-menu-item">--}}
